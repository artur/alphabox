...
| Memory | 64 MB – 32 GB |
| Storage | Symbios 53C810 / 53C895 SCSI, ALi M1543C IDE (disks and ATAPI CD-ROM), 82077AA floppy, RAM disk |
...
| Network | DEC 21143 (Tulip) — host access through pcap, TUN/TAP (Linux) or a null back end |
