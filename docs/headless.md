...
| `ALPHABOX_JIT_PINSET=1\|2` | Experiment: pin a different set of guest registers (AArch64 emitter). `1` gives R17, R18 and R27's slots to R13-R15, the nada benchmark's hot registers; `2` gives R9-R11, R26, R27, R29 and R30's to R8, R4-R6 and R21-R23, those of Microsoft's `makecab`. See docs/performance.md, "What a pinned register is worth". |
