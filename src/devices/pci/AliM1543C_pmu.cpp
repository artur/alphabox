...
//   CFCS  = 0x02000000 : DEVSEL=medium; command bits all clear at reset
//   CFRV  = 0x06800000 : class 0x06 / subclass 0x80 (bridge / other)
//   CFIT  = 0x00000000 : 30h-3Fh reserved on the M7101 (M1543C datasheet p. 78)
...
//   CFCS  bit 0x1 only : I/O Space Enable is the sole R/W command bit; MEM
//         and BME read as 0 (M1543C datasheet p. 77)
